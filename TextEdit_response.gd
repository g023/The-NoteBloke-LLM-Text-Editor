...
func do_context(str_id):
	...
	var tokens_max 		= int($"../../../../../../VBoxContainer_editor/ColorRect/VBoxContainer/HBoxContainer/TextEdit_maxtokens".text)
	var ai_memory_pre 	= int($"../VBoxContainer/HBoxContainer3/TextEdit_mem_pre".text)
	var ai_memory_post 	= int($"../VBoxContainer/HBoxContainer3/TextEdit_mem_post".text)
	var txt_assistant 	= ""
	var txt_prompt 		= ""
...
func llm_get_headers(openai=false):
	var headers = []
	if openai:
		var api_key = $"../../../../../../VBoxContainer_editor/ColorRect/VBoxContainer/HBoxContainer/TextEdit_oai_key".text
...
func llm_get_body_short(the_messages, max_tokens, temperature, frequency_penalty, presence_penalty):
	...
	var openai = $"../../../../../../VBoxContainer_editor/ColorRect/VBoxContainer/HBoxContainer/CheckBox_use_openai".button_pressed
