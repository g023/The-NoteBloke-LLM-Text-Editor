...
# g_node_openai_checkbox,g_node_openai_key,g_node_max_tokens,g_node_pre,g_node_post
@onready var g_node_openai_checkbox = $"../HBoxContainer/CheckBox_use_openai"
...
@onready var g_node_pre = $"../../../../VBoxContainer_control/ColorRect/VBoxContainer/VSplitContainer/VBoxContainer2/VBoxContainer/HBoxContainer3/TextEdit_mem_pre"
@onready var g_node_post = $"../../../../VBoxContainer_control/ColorRect/VBoxContainer/VSplitContainer/VBoxContainer2/VBoxContainer/HBoxContainer3/TextEdit_mem_post"
...
func do_context(str_id):
	...
	var ai_memory_pre 	= int(g_node_pre.text)
	var ai_memory_post 	= int(g_node_post.text)
	var txt_assistant 	= ""
	var txt_prompt 		= ""
...
func llm_get_body_short(the_messages, max_tokens, temperature, frequency_penalty, presence_penalty):
	...
	# g_node_openai_checkbox,g_node_openai_key,g_node_max_tokens,g_node_pre,g_node_post
	var openai = g_node_openai_checkbox.button_pressed
